...
| [The photo object store](object-store.md) | touching `Charts/impact-kids/templates/s3/` or the SeaweedFS container. Why it has no ingress, why the backup job's credential cannot write, and why the SeaweedFS volume flags are not tuning. |
