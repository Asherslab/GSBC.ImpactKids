---
title: Team points, wall displays and the end of night reveal
kind: reference
status: current
module: games
verified: 2026-08-24
code:
  ...
  - GSBC.ImpactKids.Grpc/Features/Games
  - GSBC.ImpactKids.Shared.Contracts/Entities/Features/Games
---
